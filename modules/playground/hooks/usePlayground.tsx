  ...
  const loadPlayground = useCallback(async () => {
    ...
    try {
      ...
      if (typeof rawContent === "string") {
        ...
        toast.success("Playground has been loaded successfully.");
        return;
      }
      ...
      if (
        ...
        setTemplateData({
          folderName: templateRes.templateJson.folderName,
      ...
      toast.success("Template has been loaded successfully.");
    } catch (error) {
