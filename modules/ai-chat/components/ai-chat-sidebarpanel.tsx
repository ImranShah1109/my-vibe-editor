        ...
        while (true) {
          ...
          for (const line of lines) {
            if (line.startsWith("data: ")) {
              ...
              setStreamMessage((prev) => prev + data?.content);
            ...
            <div className="p-6 space-y-6">
              ...
              {streamMessage != "" && (
                <div className="space-y-4">
                  <div
                    className={cn("flex items-start gap-4 group justify-start")}
                  >
                    <div className="relative w-10 h-10 border rounded-full flex flex-col justify-center items-center">
                      <Brain className="h-5 w-5 text-zinc-400" />
                    </div>
                    ...
                    <div
                      className={cn(
                        "max-w-[85%] rounded-xl shadow-sm bg-zinc-900/80 backdrop-blur-sm text-zinc-100 p-5 rounded-bl-md border border-zinc-800/50"
                      )}
                    >
                      <MessageTypeIndicator
                        type={filterType}
                      ...
                      <div className="flex items-center justify-between mt-3 pt-2 border-t border-zinc-700/30">
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              navigator.clipboard.writeText(streamMessage)
                            }
                            className="h-6 w-6 p-0 text-zinc-400 hover:text-zinc-200"
                          >
                            <Copy className="h-3 w-3" />
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => setInput(streamMessage)}
                            className="h-6 w-6 p-0 text-zinc-400 hover:text-zinc-200"
                          >
                            <RefreshCw className="h-3 w-3" />
                          </Button>
          ...
          >
            <div className="flex items-end gap-3">
              ...
              <Button
                ...
                className="h-11 px-4 bg-blue-600 hover:bg-blue-700 text-white border-0 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
              >
                {isLoading ? (
