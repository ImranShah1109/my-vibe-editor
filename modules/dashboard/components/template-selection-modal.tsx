    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#4F07D1] flex items-center gap-2">
                <Plus size={24} className="text-[#4F07D1]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-[#4F07D1] shadow-[0_0_0_1px_#4F07D1,0_8px_20px_rgba(79,7,209,0.15)]"
                              : "hover:border-[#4F07D1] shadow-[0_2px_10px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }
                          `}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#4F07D1] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#4F07D1] hover:bg-[#3c05a1] cursor-pointer text-white"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#4F07D1]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#4f07d1,0_8px_20px_rgba(79,7,209,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#4F07D1]" />
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <Button
                className="bg-[#4F07D1] hover:bg-[#3c05a1] text-white"
