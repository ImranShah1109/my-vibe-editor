...
import type { Project } from "@/modules/dashboard/type";
...
export default function ProjectTable({
  ...
  const handleMarkasFavorite = async (project: Project) => {
    ...
    try {
      ...
      toast.success("Project has been marked as favourite.");
    } catch (error) {
      toast.error("Failed to mark project as favourite");
      console.log("Error in marking project as favourite: ", error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDuplicateProject = async (project: Project) => {
    ...
    try {
      ...
      toast.success("Project has been duplicated successfully.");
    } catch (error) {
      toast.error("Failed to duplicte project.");
      console.log("Error in duplicating a project: ", error);
    } finally {
      setIsLoading(false);
    }
  };
            ...
            {projects.map((project) => (
              <TableRow key={project.id}>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="bg-[#4F07D115] text-[#4F07D1] border-[#4F07D1]"
                  >
                    {project.template}
                  </Badge>
                </TableCell>
