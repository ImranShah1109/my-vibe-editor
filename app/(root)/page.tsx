  ...
  return (
    <div className="z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      <div className="flex flex-col justify-center items-center my-5">
        ...
        <h1 className="z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-700 via-violet-700 to-blue-600 dark:from-purple-600 dark:via-violet-600 dark:to-blue-500 tracking-tight leading-[1.3] ">
          Vibe Code With with Intelligence
        </h1>
      </div>

      <p className="mt-2 text-lg text-center text-gray-600 dark:text-blue-200 px-5 py-10 max-w-2xl">
